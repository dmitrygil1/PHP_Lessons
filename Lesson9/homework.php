...
//Алгоритм решается напрямую, в лоб. Пройдите циклом по всем символам и постепенно прибавляйте количество
//нужных символов.
//
//
//Что оценивается
...
//
//Советы и рекомендации
//Можно пройтись циклом по всем элементам, пропуская те, что стоят на нечётных местах, а можно составить цикл так,
//чтобы он проходил только по нечётным позициям.
//
//
//Что оценивается
//Алгоритм должен решать требуемую задачу.
...
//с максимальной разрешённой скоростью. Для каждой машины выведите подобную строку:
